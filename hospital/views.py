...
#for showing signup/login button for admin(by HARIPRIYA)
...
#for showing signup/login button for doctor(by HARIPRIYA)
...
#for showing signup/login button for patient(by HARIPRIYA)
...
#-----------for checking user is doctor , patient or admin(by HARIPRIYA)
def is_admin(user):
...
#Developed By : HARIPRIYA kumar
#facebook : fb.com/HARIPRIYA.luv
#Youtube :youtube.com/MediCare Hubs
